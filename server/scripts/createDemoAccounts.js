...
// Random date generator for transactions within the specified range
function randomDateBetween(start, end) {
  return new Date(start.getTime() + Math.random() * (end.getTime() - start.getTime()));
}

// Random amount generator with some decimal precision
...
// Format date to YYYY-MM-DD for the Transaction model
